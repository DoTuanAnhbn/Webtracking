...
<div class="container">
  <ul class="pagination" style = "padding-left:50px;margin:0; list-style:None;">
    <li class="disabled" style ="float:left; background:#DFF0EE; display:block;  padding:5px; margin:5px;">
      <a class="page-link" href="index.php" aria-label="Previous" style="color:#000; text-align:center; text-decoration:none;">
    ...
    <li  style ="float:left; background:#E88686; display:block;  padding:5px; margin:5px;"><a href="#" style="color:#000; text-align:center; text-decoration:none;">TRẠM 2</a></li>
    <li  style ="float:left; background:#DFF0EE; display:block;  padding:5px; margin:5px;"><a href="page_3.php" style="color:#000; text-align:center; text-decoration:none;">TRẠM 3</a></li>
    <li class="page-item" style ="float:left; background:#DFF0EE; display:block;  padding:5px; margin:5px;">
      <a class="page-link" href="page_3.php" aria-label="Next" style="color:#000; text-align:center; text-decoration:none;">
...
<div class= "row_1" style="width: auto;height: auto;">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.816995730751!2d105.83928891473086!3d20.999971686013907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xce352f66eed0e578!2zMjDCsDU5JzU5LjkiTiAxMDXCsDUwJzI5LjMiRQ!5e0!3m2!1svi!2s!4v1654885880696!5m2!1svi!2s" width="500" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</div>
...
setInterval(function () {
		...
		xmlhttp.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
		        ...
		        json_temp = myArr['temp_2']
		        json_humi = myArr['humi_2']
		        json_soil_moisture = myArr['soil_moisture_2']
		    }
		};
...
setInterval(function () {
		...
		xmlhttp.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
		        var myArr = JSON.parse(this.responseText);
		        json_rainfall = myArr['rainfall_2']
		    }
		};
		xmlhttp.open("GET", url, true);
		xmlhttp.send();
